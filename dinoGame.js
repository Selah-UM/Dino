...
function drawBackGrounds(){
  ...
  for(const backGround of game.backGrounds){
    ...
    ctx.fillRect(backGround.x+10, backGround.y - 10, backGround.width - 20, 5);
    ctx.fillRect(backGround.x+25, backGround.y - 15, backGround.width - 50, 5);
  }
}
function drawDino(){
